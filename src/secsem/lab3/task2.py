...
def main():
    # 1) Копирование файла из предыдущего задания
    ...
    # 2) Переименование файла и создание вложенных директорий
    ...
    # 3) Создание нового файла, перемещение и переименование одной командой
    ...
    # 4) Создание дополнительных файлов и вывод содержимого
    for i in range(1, 4):
    ...
    # 6) Обход директорий и вывод структуры
    print("\nОбход директорий:")
